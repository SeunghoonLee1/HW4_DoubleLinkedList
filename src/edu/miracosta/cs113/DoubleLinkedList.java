...
public class DoubleLinkedList<E> implements List<E> {
    ...
    public ListIterator<E> listIterator(){//Is it returning ListIterator<E> return type?
        //Isn't it returning a DoublyLinkeListIterator type object?
    ...
    public void add(int index, E element){
        ...
        if(nodeBeforeIndex != null){
            ...
            //When it is the first node, update hea
            head = newNode;
        }if(index == size){
            tail = newNode;
        }
...
//            }
        ...
        public void remove(){
            ...
            if(lastDataReturned.next.equals(nextData)){//when 'next' was previously called
